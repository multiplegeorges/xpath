module XPath
  module HTML
    ...
    def link(locator, options={})
      ...
      link[attr(:id).equals(locator) | string.n.is(locator) | attr(:title).is(locator) | descendant(:img)[attr(:alt).is(locator)] | descendant(:strong, :b, :em, :span, :i).text.is(locator)]
    end
